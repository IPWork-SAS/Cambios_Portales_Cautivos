            ...
            <div class="col-sm-12 my-auto">
                <div class="card"> 
                    <div class="screen">
                        ...
                        <p class="desc"><?=$styles->title_portal ? $styles->title_portal : $lang['titulo_form'];?></p>
                          ...
                          <?php
                            ...
                            if((isset($datosCampania['nombre']) && isset($datosCampania['apellidos'])) && (isset($datosCampania['estado_nombre']) || isset($datosCampania['estado_apellidos']))) {
                                echo '
                                    <div class="form-group" name="form_group_nombre" id="form_group_nombre">
                                        <input type="text" required autocomplete="off" class="form-input" onkeyup="dropInvalidCharactersNombre();" id="nombre" name="nombre" onfocus="restaurarInputNombre()" placeholder="'.$lang['nombre_form'].'">
                                    ...
                                    <div class="form-group" name="form_group_apellidos" id="form_group_apellidos">
                                        <input type="text" autocomplete="off" required class="form-input" onkeyup="dropInvalidCharactersApellidos();" id="apellidos" name="apellidos" onfocus="restaurarInputApellidos()" placeholder="'.$lang['apellidos_form'].'">
                                        <div class="container-error-span">
                            ...
                            if (isset($datosCampania['email']) && isset($datosCampania['estado_email'])) {
                                ...
                                <div class="form-group" id="form_group_email"  name="form_group_email">
                                    <input type="email" required id="email" class="form-input" name="email" onfocus="restaurarInputEmail()" placeholder="'.$lang['email_form'].'">
                                    <div class="container-error-span">
                            ...
                            if (isset($datosCampania['telefono']) && isset($datosCampania['estado_telefono'])) {
                                ...
                                <div class="form-group" id="form_group_telefono"  name="form_group_telefono">
                                    <input type="tel" onkeyup="dropInvalidCharactersTelefono()" class="form-input" id="telefono" name="telefono" onfocus="restaurarInputTelefono()" placeholder="'.$lang['celular_form'].'" required>
                                    <div class="container-error-span">    
                            ...
                            if (isset($datosCampania['edad']) && isset($datosCampania['estado_edad'])) {
                                ...
                                <div class="form-group" id="form_group_edad"  name="form_group_edad">
                                    <input type="text" onkeyup="dropInvalidCharactersAge()" class="form-input" id="edad" name="edad" onfocus="restaurarInputEdad()" placeholder="'.$lang['edad_form'].'" maxlength = "2" required>
                                    <div class="container-error-span">
                            ...
                            if (isset($datosCampania['genero']) && isset($datosCampania['estado_genero'])) {
                                ...
                                <div class="form-group" id="form_group_genero"  name="form_group_genero">
                                    <select id="genero"  name="genero" class="form-select" required onfocus="restaurarInputGenero()">
                            ...
                            if (isset($datosCampania['num_habitacion']) && isset($datosCampania['estado_num_habitacion'])) {
                                ...
                                <div class="form-group" id="form_group_habitacion"  name="form_group_habitacion">
                                    <input type="text" required autocomplete="off" class="form-input" onkeyup="dropInvalidCharactersHabitacion()" id="num_habitacion" name="num_habitacion" onfocus="restaurarInputHabitacion()" placeholder="'.$lang['num_habitacion_form'].'">
                                    <div class="container-error-span">
                            ...
                            if (isset($datosCampania['num_voucher']) && isset($datosCampania['estado_num_voucher'])) {
                                ...
                                <div class="form-group" id="form_group_voucher" name="form_group_voucher">
                                    <input type="text" required autocomplete="off" class="form-input" id="num_voucher" name="num_voucher" onfocus="restaurarInputVoucher()" placeholder="'.$lang['voucher_form'].'">
                                    <div class="container-error-span">
                            ...
                            if (isset($datosCampania['razon_visita']) && isset($datosCampania['estado_razon_visita'])) {
                                ...
                                <div class="form-group" id="form_group_razon_visita"  name="form_group_razon_visita">
                                    <select id="razon_visita" class="form-select" name="razon_visita" required onfocus="restaurarInputRazonVisita()">
